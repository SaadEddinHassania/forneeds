...
class ServiceTypeController extends AppBaseController
{
    ...
    {
        return $serviceTypeDataTable->render('admin.serviceTypes.index');
    }
    ...
    {
        return view('admin.serviceTypes.create',['sectors'=>$this->sectorRepository->all()->lists('name','id')->toarray()]);
    }
